    ...
    return (
        <>
            <div className="im-content basis-3/5 px-10">
                ...
                <p className='text-[#808dad] text-xl'>I'm Ankit Das, a skilled Full Stack Developer with 6 years of experience in developing scalable web applications. My passion for innovation drives me to create solutions that leave a lasting impact.</p>
